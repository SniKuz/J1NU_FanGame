...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData(){
        ...
        talkData.Add(1000 + 3, new string[]{    "여기는 굿즈 공장입니다.:0",
                                                ...
                                                "계속 켜놓아도 돈은 안주고 보너스 횟수만 떨어지니 굿즈를 팔 때만 켜놓으면 좋겠네요:0",
        ...
        talkData.Add(1000 + 4, new string[]{    "역시 사장님! 우측 상단의 숫자가 올라간게 보이죠?:3",
                                                ...
                                                "위에서부터 돈, 굿즈, 시청자, 굿즈 디자인 보너스 횟수 입니다.:0",
                                                "그럼 바로 다음으로 가볼까요?:0",
        ...
        talkData.Add(1000 + 6, new string[]{    "저장공간도 늘었네요.:3",
                                                ...
                                                "한번만 누르면 ON/OFF가 되고 굿즈가 없으면 자동으로 꺼집니다.:0",
        ...
        talkData.Add(1000 + 7, new string[]{    "여러 주식들이 보이죠?:0",
                                                ...
                                                "1게이지는 15초이고, 5게이지가 지나면 하루가 지나며 장이 마감됩니다.:0",
                                                "장이 마감되면 몇몇 주식은 상장폐지되고 몇몇 주식은 상장되니 조심해야겠네요.:0",
                                                "한 가지 팁으로 Buy 혹은 Sell 버튼을 클릭해서 고르고 Space바를 연타해도 클릭으로 적용이 됩니다!:3",
                                                "더 빨리 사거나 팔 수 있을 수도 있다 생각합니다.:4",
                                                "이제 다음 패널로 가볼까요?:0",
                                                "밑에 스트리머 패널을 눌러보죠.:0"});    
        ...
        talkData.Add(1000 + 12, new string[]{   "노동부를 포함한 몇몇 사람들을 제외한 대부분은 실제로 저렇게 알고 있습니다.:0",
        ...
        talkData.Add(1000 + 13, new string[]{   "다음은 탬탬버린님의 밀감 컴퍼니입니다.:0",
        ...
        //#2. 지누 : 11, 아리스톨 : 13 금사향 : 1  코렛트 : 4 탬탬 :-1 나나양 :-1 :talkState
        ...
        talkData.Add(1000 + 14, new string[]{   "상황을 보니 탬탬버린님은 어떤 이유에서든 오해가 있었던 것 같군요.:0",
        ...
        talkData.Add(1000 + 15, new string[]{   "우주대스타 컴퍼니의 나나양님입니다.:0",
        ...
        talkData.Add(1000 + 16, new string[]{   "알겠습니다.:0",
                                                "죄송합니다 탬탬님... 명령인지라:1"
                                                });
        ...
        //#3. 지누 : 21, 아리스톨 : 16 금사향 : 4  코렛트 : 5 탬탬 : 12 나나양 :-1 :talkState
        ...
        talkData.Add(1000 + 17, new string[]{   "원두컴퍼니는 지누님 입대 이후 생긴 SPAC입니다.:0",
        ...
        talkData.Add(1000 + 18, new string[]{   "PIXEL의 주식을 사서 조각난 회사를 하나로 합쳐야합니다.:0",
        ...
        talkData.Add(1000 + 19, new string[]{   "네 알겠습니다.:0",
                                                "나나양님 죄송합니다...:0"
                                                });
        ...
        //#4. 지누 : 28, 아리스톨 : 19 금사향 : 4  코렛트 : 6 탬탬 : 13 나나양 :5 :talkState
